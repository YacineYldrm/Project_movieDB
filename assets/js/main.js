...
const searchInput = document.body.querySelector('#searchbar');
const yearUpBtn = document.body.querySelector('#yearUpBtn');
...
searchbar.addEventListener('input', () => 
{
    ...
    {
        if(movie[0].toLowerCase().includes(userInput) || movie[2].toLowerCase().includes(userInput))
        {
            return movie;
        } 
    })

    // display search result + error handling
    if(movieMatch.length > 0)
    {
        showMovie(movieMatch);
    }
    else
    {
...
yearUpBtn.addEventListener('click', () =>
{
    event.preventDefault();
    movieGallery.innerHTML = "";
    const sortedYearUp = movies.sort((movie1, movie2) => movie1[1] - movie2[1]);
    showMovie(sortedYearUp);
});

// sort movies: year down
yearDownBtn.addEventListener('click', () =>
{
    event.preventDefault();
    movieGallery.innerHTML = "";
    const sortedYearDown = movies.sort((movie1, movie2) => movie2[1] - movie1[1]);
    showMovie(sortedYearDown);
});

// sort movies: best rate
bestRateBtn.addEventListener('click', () =>
{
    event.preventDefault();
    movieGallery.innerHTML = "";
    const sortedBestRate = movies.sort((movie1, movie2) => movie2[5] - movie1[5]);
    showMovie(sortedBestRate);
});